...
public class CreateAdminFrame extends JFrame {
    ...
    private void configuraJanela() {
        ...
        setTitle("Controle de Administradores");
        setResizable(false);
        ...
        this.addWindowListener(new CreateAdminWindowEvents(this));
    }

    private void configRightPanel() {
        //painel com 3 subdivisoes
        rightPanel = new JPanel();
        rightPanel.setBorder(BorderFactory.createTitledBorder(lineBorder, "Administrador"));
    ...
    private void configMidGap(JPanel midGap) {
        ...
        adicionar.addMouseListener(new CreateAdminEvents(this, adicionar));

        JButton editar = new JButton("Editar");
        editar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        editar.setBackground(Color.WHITE);
        editar.setForeground(Color.black);
        editar.addMouseListener(new CreateAdminEvents(this, editar));
        ...
        limpar.addMouseListener(new CreateAdminEvents(this, limpar));
        ...
        remover.addMouseListener(new CreateAdminEvents(this, remover));
    ...
    private void configLeftPanel() {
        ...
        leftPanel.setBorder(BorderFactory.createTitledBorder(lineBorder, "Administradores"));
        ...
        list.addListSelectionListener(new CreateAdminListEvent(this));
    ...
    public static void main(String[] args) {
        CreateAdminFrame tela = new CreateAdminFrame();
        tela.montaTela();
    }
}
