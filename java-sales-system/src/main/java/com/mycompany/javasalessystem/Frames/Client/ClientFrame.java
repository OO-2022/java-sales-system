...
public class ClientFrame extends JFrame{
    ...
    public void setTfPhone(JPasswordField tfPhone) {
    ...
    public void setTfOccupation(JTextField tfCep) {
        this.tfCep = tfCep;
    }
    ...
    private void configuraJanela() {
        ...
        this.addWindowListener(new ClientWindowEvents(this));
    }

    private void configRightPanel() {
        //painel com 3 subdivisoes
        rightPanel = new JPanel();
        rightPanel.setBorder(BorderFactory.createTitledBorder(lineBorder, "Cliente"));
    ...
    private void configMidGap(JPanel midGap){
        ...
        adicionar.addMouseListener(new ClientEvents(this, adicionar));
        
        JButton editar = new JButton("Editar");
        editar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        editar.setBackground(Color.WHITE);
        editar.setForeground(Color.black);
        editar.addMouseListener(new ClientEvents(this, editar));
        ...
        limpar.addMouseListener(new ClientEvents(this, limpar));
        ...
        remover.addMouseListener(new ClientEvents(this, remover));
    ...
    private void configLeftPanel() {
        ...
        list.addListSelectionListener(new ClientListEvent(this));
    ...
    public static void main(String[] args) {
        ClientFrame tela = new ClientFrame();
        tela.montaTela();
    }
}
